...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func logoutSuccessful() {
        var slidingView :UINavigationController!
        var storyboard : UIStoryboard! = UIStoryboard(name: "Main", bundle: nil)
        slidingView = storyboard.instantiateViewControllerWithIdentifier("NavSplashViewController") as UINavigationController
        UIApplication.sharedApplication().keyWindow?.rootViewController = slidingView as UINavigationController
    }
